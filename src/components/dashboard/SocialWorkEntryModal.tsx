                    ...
                    <div className="flex-1 flex justify-end">
                        {step === 1 ? (
                            <button
                                ...
                                className="h-12 px-8 rounded-xl bg-amber-500 text-white text-sm font-bold hover:brightness-110 shadow-sm active:scale-95 transition-all disabled:opacity-50 disabled:grayscale flex items-center gap-2"
                            >
                                Próximo Passo
                            ...
                            <button
                                ...
                                className="h-12 px-8 rounded-xl bg-amber-500 text-white text-sm font-bold hover:brightness-110 shadow-sm active:scale-95 transition-all disabled:opacity-50 disabled:grayscale flex items-center justify-center gap-2 min-w-[200px]"
                            >
